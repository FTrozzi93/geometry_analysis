...
#Automatize the test of a single function of multiple parameters
...
# Create a test that raise the error without failing the test
...
def test_molecule_set_coodinates(water_molecule):
